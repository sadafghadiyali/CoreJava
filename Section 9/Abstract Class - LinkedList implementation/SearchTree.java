public class SearchTree implements NodeList{
    ...
    public boolean addItem(ListItem item){
        ...
        while(currentItem!= null){
            ...
            if(compareResult < 0) { // cuurentItem is small & item is greater . move right
            ...
            else if(compareResult > 0) { //currentItem is larger than item. move left
    ...
    public boolean removeItem(ListItem item){
        ...
        while(currentItem != null){
            int compareResult = currentItem.compareTo(item);
            if(compareResult > 0){ //currentItem > item . move left
